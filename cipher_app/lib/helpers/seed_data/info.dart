...
Future<void> seedInfoDatabase(Database db) async {
  await db.transaction((txn) async {
    ...
    await txn.insert('app_info', {
      ...
      'description':
          'Começamos uma nova série sobre os livros de Samuel. Toda quarta-feira às 19h30.',
      'type': 'announcement',
    ...
    await txn.insert('app_info', {
      ...
      'description':
          'Domingo especial de ação de graças com testemunhos e louvor.',
      'content':
          '{"date": "2025-08-27T09:00:00Z", "location": "Templo Principal"}',
      'type': 'event',
    ...
    await txn.insert('app_info', {
      ...
      'content':
          '{"date": "2025-08-29T19:00:00Z", "location": "Casa do Irmão João"}',
      'type': 'news',
    ...
    await txn.insert('app_info', {
      ...
      'description':
          'Ensaio especial para o coral da igreja. Participação obrigatória para todos os membros.',
      'content':
          '{"date": "2025-08-26T19:30:00Z", "location": "Sala de Música"}',
      'type': 'announcement',
      'priority': 2,
    ...
    await txn.insert('app_info', {
      ...
      'title': 'Retiro Jovens',
      'description':
          'Retiro especial para jovens de 15 a 25 anos. Inscrições abertas!',
      'content':
          '{"date": "2025-09-05T08:00:00Z", "location": "Sítio da Paz", "deadline": "2025-08-30T23:59:59Z"}',
      'type': 'event',
      'priority': 3,
