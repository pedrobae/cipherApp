...
class CipherLibraryScreen extends StatefulWidget {
  ...
  const CipherLibraryScreen({super.key, this.selectionMode = false, this.playlistId, this.excludeVersionIds,});
...
class _CipherLibraryScreenState extends State<CipherLibraryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (widget.selectionMode && widget.excludeVersionIds != null) {
                        final hasExcludedVersions = cipher.maps.any(
                          (version) => widget.excludeVersionIds!.contains(version.id),
                        );
      ...
      floatingActionButton: widget.selectionMode ? null : FloatingActionButton.extended(
        onPressed: () {
          Navigator.of(
            context,
            rootNavigator: true,
