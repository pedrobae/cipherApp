...
class BrandPalette extends Palette {
  ...
  static final Color greenDark = Palette.darken(Palette._green, 0.12);
  ...
  static final Color greenContainerDark = Palette.darken(Palette._green, 0.25);
  ...
  static final Color greenAccent1Light = Palette.lighten(greenAccent1, 0.1);
  static final Color greenAccent1Dark = Palette.darken(greenAccent1, 0.2);
  ...
  static final Color greenAccent2Dark = Palette.darken(greenAccent2, 0.25);
  ...
  static final Color orangeAccent1Light = Palette.lighten(orangeAccent1, 0.1);
  static final Color orangeAccent1Dark = Palette.darken(orangeAccent1, 0.2);
  ...
  static final Color orangeAccent2Dark = Palette.darken(orangeAccent2, 0.25);
  ...
  static final Color goldDark = Palette.darken(Palette._gold, 0.15);
  static final Color goldOnLight = Palette._darkNeutral;
  static final Color goldOnDark = Palette._neutral;
  static final Color goldContainerLight = Palette.lighten(Palette._gold, 0.18);
  static final Color goldContainerDark = Palette.darken(Palette._gold, 0.25);
  static final Color goldOnContainerLight = Palette._darkNeutral;
  static final Color goldOnContainerDark = Palette._neutral;
  ...
  static final Color goldAccent1Light = Palette.lighten(goldAccent1, 0.1);
  static final Color goldAccent1Dark = Palette.darken(goldAccent1, 0.2);
  static final Color goldOnAccent1Light = Palette._darkNeutral;
  static final Color goldOnAccent1Dark = Palette._neutral;
  ...
  static final Color goldAccent2 = Color.alphaBlend(
    Palette._burgundy.withAlpha(0x38), // 22% blend
    Palette._gold,
  );
  static final Color goldAccent2Light = Palette.lighten(goldAccent2, 0.15);
  static final Color goldAccent2Dark = Palette.darken(goldAccent2, 0.25);
  ...
  static final Color burgundyDark = Palette.darken(Palette._burgundy, 0.15);
  static final Color burgundyOnLight = Palette._darkNeutral;
  ...
  static final Color burgundyOnContainerLight = Palette._darkNeutral;
  ...
  static final Color burgundyAccent1Light = Palette.lighten(
    burgundyAccent1,
    0.1,
  );
  static final Color burgundyAccent1Dark = Palette.darken(burgundyAccent1, 0.2);
  static final Color burgundyOnAccent1Light = Palette._darkNeutral;
  ...
  static final Color burgundyOnAccent1ContainerLight = Palette._darkNeutral;
  ...
  static final Color burgundyOnAccent2Light = Palette._darkNeutral;
  ...
  static final Color burgundyOnAccent2ContainerLight = Palette._darkNeutral;
...
class NeutralPalette extends Palette {
  ...
  static final Color outlineLight = Palette.lighten(
    Palette._neutral,
    0.5,
  ); // Light outline
  static final Color outlineDark = Palette.darken(
    Palette._darkNeutral,
    0.5,
  ); // Dark outline

  static final Color shadowLight = Color(
    0x1A000000,
  ); // Light shadow (10% opacity)
  static final Color shadowDark = Color(
    0x33000000,
  ); // Dark shadow (20% opacity)

  static final Color scrimLight = Color(0x0D000000); // Light scrim (5% opacity)
  static final Color scrimDark = Color(0x1A000000); // Dark scrim (10% opacity)
